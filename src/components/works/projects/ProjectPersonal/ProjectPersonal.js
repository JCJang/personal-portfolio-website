  ...
  useDebounce(()=>{
    ...
    {loading && <motion.div key="loader" style={{
       ...
       <Research
         ...
         competitiveAnalysis="$UX portfolio criteria:$The Google UX design course on Coursera recommends that UX portfolios be consistent in tone, and have a minimum of three projects. Each case study should be illustrative of design thinking and process, and provide context, roles, takeaways, and a lot of visuals to make the case study skimmable. The tone should be clear and concise./$frontend developer portfolio criteria:$ Junior developer portfolios that received positive feedback shows the developer’s problem-solving skills and thought process, and include a link to the final project and repository. Sections such as ‘Skills’ are discouraged, since evaluators prefer to see how developers apply those skills. Users should have the ability to read about projects before clicking into one, and a summary section should be included at the top of each case study./I began structuring my case study contents according to the above criteria. I included many visuals, and I tried to show my trials and errors, and how I solved the situation in each case. I also included many visuals and animations, as well as a table of contents and summary. To illustrate my development process, I created gist samples that demonstrate problem solving and included visuals."
