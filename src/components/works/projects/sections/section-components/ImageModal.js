    ...
    <TransformWrapper>
      {
        ({
          ...
          <div className="Row" style={{
            ...
            <button className="modalBtn" onClick={() => zoomIn()}><ZoomInIcon style={{
            fontSize: "1.2rem"
          }}/></button>
            <button className="modalBtn" onClick={() => zoomOut()}><ZoomOutIcon style={{
            fontSize: "1.2rem"
          }}/></button>
            <button className="modalBtn" onClick={() => resetTransform()}><ResetIcon style={{
            fontSize: "1.2rem"
          }}/></button>
            <button className="modalBtn modalCloseBtn" style={{
                right: "0",
                position: "absolute"
              }} onClick={onClose}><CloseIcon style={{
            fontSize: "1.2rem"
          }}/></button>
          </div>
          <TransformComponent>
